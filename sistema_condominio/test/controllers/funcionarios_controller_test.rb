...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { apartamento_id: @funcionario.apartamento_id, ativo: @funcionario.ativo, data_alteracao: @funcionario.data_alteracao, data_inclusao: @funcionario.data_inclusao, dias_autorizados: @funcionario.dias_autorizados, nome: @funcionario.nome, tel: @funcionario.tel } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { apartamento_id: @funcionario.apartamento_id, ativo: @funcionario.ativo, data_alteracao: @funcionario.data_alteracao, data_inclusao: @funcionario.data_inclusao, dias_autorizados: @funcionario.dias_autorizados, nome: @funcionario.nome, tel: @funcionario.tel } }
