...
ActiveRecord::Schema.define(version: 20180404174258) do
  ...
  create_table "descricao_despesa_receita", force: :cascade do |t|
    t.string   "descricao"
    t.string   "natureza"
  ...
  create_table "despesas", force: :cascade do |t|
    ...
    t.datetime "data_inclusao"
    t.datetime "data_alteracao"
    t.integer  "descricao_despesa_receita_id"
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
    t.index ["descricao_despesa_receita_id"], name: "index_despesas_on_descricao_despesa_receita_id"
  end
  ...
  create_table "receita_a_recebers", force: :cascade do |t|
    ...
    t.index ["descricao_despesa_receita_id"], name: "index_receita_a_recebers_on_descricao_despesa_receita_id"
